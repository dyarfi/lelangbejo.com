...
class Home extends MY_Controller {
    ...
    public function step3()
    {
        ...
        if($point == 'no'){
            $data['error'] = "
            KOIN Konco Bejo tidak mencukupi untuk ikut Lelang.<br>Monggo beli Bintang Toedjoe Masuk Angin kemasan isi 5 dan submit Kode Transaksi serta upload foto struk pembelian untuk mendapatkan KOIN.
            ";
        }
    ...
    public function dompet()
    {
        ...
        $data['user'] = $user;
        $data['rows'] = $this->point_mod->get_rows(FALSE,$where,TRUE,0,20,$sort);
        $data['upload'] = $this->input->get('upload');
